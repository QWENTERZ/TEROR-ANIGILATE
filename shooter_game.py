...
apparat = transform.scale(image.load("nix.jpg"),(window1, window2))
...
class Player(GameSprite):
    def update(self):
        ...
        if keys_pressed[K_a]:
            self.rect.x -= 20
    def fire(self):
        bullet = Bullet("bullet.png", self.rect.centerx,self.rect.top, 6)
        bullets.add(bullet)
#класс вражины===================================================================================================
...
#спрайтики===================================================================================================
appartik = Player("tb.jpg", 20, 400, 15)
